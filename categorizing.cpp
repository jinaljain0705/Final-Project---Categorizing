/*
  Project Definition: Categorizing

  Main Objective: Design, implement, and test key data structures and algorithms, and apply
  ...
  Requirements: 
    - Linked list 
    - Binary Search
    - Merge and Quick Sorting

  Application: Create a menu-driven program that combines all data structures and algorithms implemented.
  Tasks:
